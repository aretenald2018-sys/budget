...
<div class="tds-modal-overlay" id="tx-edit-modal" role="dialog" aria-modal="true" aria-label="거래 상세">
...
function ensureTxAddModal() {
  ...
  container.insertAdjacentHTML('beforeend', `
    <div class="tds-modal-overlay" id="tx-add-modal" role="dialog" aria-modal="true" aria-label="거래 추가">
      <div class="tds-modal-sheet">
        <div class="tds-modal-handle" aria-hidden="true"></div>
        <div class="tds-modal-content" style="text-align:left">

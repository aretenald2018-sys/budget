...
- production 배포: `e597bd4`가 `main`에 push됐고 GitHub Pages run `28637241321`이 성공했다. production metadata와 downloaded APK manifest에서 v2.0.5/6 및 notification listener 포함을 확인했다.
